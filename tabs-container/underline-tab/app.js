...
const tabOne = () => {
  ...
  tabOneBtn.style.color = '#782CE8';
  tabTwoBtn.style.color = '#000000';
  tabThreeBtn.style.color = '#000000';

  tabOneBtn.style.borderBottom = 'solid #782CE8';
  tabTwoBtn.style.borderBottom = 'solid transparent';
  tabThreeBtn.style.borderBottom = 'solid transparent';
...
const tabTwo = () => {
  ...
  tabOneBtn.style.borderBottom = 'solid transparent';
  tabTwoBtn.style.borderBottom = 'solid #782CE8';
  tabThreeBtn.style.borderBottom = 'solid transparent';

  tabOneBtn.style.color = '#000000';
  tabTwoBtn.style.color = '#782CE8';
  tabThreeBtn.style.color = '#000000';
...
const tabThree = () => {
  ...
  tabOneBtn.style.borderBottom = 'solid transparent';
  tabTwoBtn.style.borderBottom = 'solid transparent';
  tabThreeBtn.style.borderBottom = 'solid #782CE8';

  tabOneBtn.style.color = '#000000';
  tabTwoBtn.style.color = '#000000';
  tabThreeBtn.style.color = '#782CE8';
